-- Create notification_schedules table for individual notification schedules
CREATE TABLE public.notification_schedules (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL,
  title TEXT NOT NULL,
  time TIME NOT NULL,
  days INTEGER[] NOT NULL, -- Array of day numbers (0=Sunday, 1=Monday, etc.)
...
CREATE POLICY "Users can create their own notification schedules" 
ON public.notification_schedules 
FOR INSERT 
